...
public class StandardDeviation {
	...
	public int variation() throws Exception {
		...
		URL BBandsURL = new URL("https://www.alphavantage.co/query?function=BBANDS&symbol=ETH&interval=5min&time_period=1&series_type=close"
				+ "&nbdevup=3&nbdevdn=3&apikey=YJC40GEVI5PVOITX");
...
//
	...
	public int variationSIA() throws Exception {
		...
		URL siaURL = new URL("https://www.alphavantage.co/query?function=DIGITAL_CURRENCY_INTRADAY&symbol"
				+ "=SC&market=EUR&apikey=YJC40GEVI5PVOITX&datatype=csv");

		URL BBandsURL = new URL("https://www.alphavantage.co/query?function=BBANDS&symbol=SC&interval=5min&time_period=5&series_type=close"
				+ "&nbdevup=3&nbdevdn=3&apikey=YJC40GEVI5PVOITX");
